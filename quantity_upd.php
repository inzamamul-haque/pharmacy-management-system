...
if(!isset($_SESSION['user_session'])){
	...
	$final = $amount-$amount*($discount_rate/100);
    ...
    $update_sql1 = "UPDATE on_hold SET qty = '$upd_qty' , amount = '$amount' , discount_amount = '$final' , profit_amount = '$profit_amount' where id = '$med_id'";
