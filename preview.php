  ...
  <form method="POST" action="save_invoice.php">
    ...
    <tbody>
      ...
      ?>
		...
		<td>
        <?php
         echo "<h5>".$row['discount_amount']."<h5>";
        ?>
        </td>
        </tr>
      <?php endwhile;?>
        ...
        <tr>
          ...
          while($row = mysqli_fetch_array($select_sql)){
            ...
            $discount_amount =  $row['sum(discount_amount)'];

            echo '<h5>'.$discount_amount.'</h5>';
         ...
         <tr>
          <td colspan="5" style=" text-align:right;"><strong style="font-size: 12px;">Paid Amount: &nbsp;</strong></td>
          <td colspan="2"><strong style="font-size: 12px;">
          <?php
         ...
         <tr>
          <td colspan="5" style=" text-align:right;"><strong style="font-size: 18px;">&nbsp;&nbsp;Change Amount: &nbsp;</strong></td>
          <td colspan="2"><strong style="font-size: 12px;">
          <?php

          echo '<h3>'.($paid_amount - $discount_amount).'</h3>';
