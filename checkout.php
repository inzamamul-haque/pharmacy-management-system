...
<input type="number" name="paid_amount" autocomplete="off" placeholder="Paid Amount" style="width: 300px; height:30px;  margin-bottom: 15px;"  required min="<?php echo $_GET['total']?>"><br>
