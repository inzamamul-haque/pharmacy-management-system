...
<body>  
    <form method="POST" action="update.php?invoice_number=<?php echo $invoice_number?>">
        ...
        <td><input type="number" style="width: 95px;" name="quantity" value="<?php echo $row['quantity']?>" min="1">

             <select style="width: 95px; height: 28px; border-color: #000080" name="sell_type" > 
                 <option value="<?php echo $row['sell_type']?>" enable><?php echo $row['sell_type']?></option>
                 <option value="Bot">Syrap</option>
                 <option value="Stp">Inject</option>
        ...
        <tr>
          ...
          <td><input type="text" name="used_quantity" readonly id="used_quantity"  value="<?php echo $row['used_quantity']?>" ></td>
        </tr>
        ...
        <td><input type="text" name="remain_quantity" readonly id="remain_quantity" value="<?php echo $row['remain_quantity']?>" ></td>
        ...
        <tr>
          ...
          <td><input type="number" name="actual_price" id="actual_price" value="<?php echo $row['actual_price']?>" min="1"></td>
        </tr>
        <tr>
                   <td>Selling Price:</td>

          <td><input type="number" name="selling_price" id="selling_price"   value="<?php echo $row['selling_price']?>" min="1"></td>
        </tr>
        <tr>
                   <td>Profit:</td>
