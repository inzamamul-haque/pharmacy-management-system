...
<body>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--***HEADER****---->
     ...
     <div class="container"><!---****SEARCHES_CONTENT*****--->
      ...
      <h1 style="text-align:center;">MEDICINE STOCK</h1>
       </div><br>
    ...
    <form method="POST">
          ...
          <table id="table0" class="table table-bordered" style="width: 100%; border-color: #000000 " >
           <thead>
             ...
             <th width="1%">Acutal Unit Price</th>
             <th style="background-color: orange" width="1%">Selling Unit Price</th>
        ...
        <?php $sql = "SELECT  id, bar_code, medicine_name, category, quantity,used_quantity, remain_quantity,act_remain_quantity, register_date, expire_date, company, sell_type , actual_price, selling_price, profit_price, status FROM stock order by medicine_name asc"; ?>
...
$(".delete").click(function(){//***Showing Alert When Deleting*****
  ...
  if(confirm("Delete This Medicine From Stock!!Are You Sure??")){
